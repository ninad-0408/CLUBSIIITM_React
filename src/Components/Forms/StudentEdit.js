...
const StudentEdit = () => {
    ...
    const [upstudent, setstudent] = useState(student);
                    ...
                    <div class="container mt-5 pt-5">
                        ...
                        <form >
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="full_name" name="name" value={upstudent.name}
                                    readonly />
                            </div>

                            <div class="form-group">
                                <label for="roll_no" class="form-label"> Roll No.</label>
                                <input type="text" class="form-control" id="roll_no" name="rollNo" value={upstudent.rollNo}
                                    readonly />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="mail_id" name="email" value={upstudent.email}
                                    readonly />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="branch" name="branch" value={upstudent.branch}  readonly />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="batch" name="batch" value={upstudent.batch}  readonly />


                                <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                            </div>

                            <button type="submit" class="btn btn-primary" onClick={() => handleSubmit(studentId)}>Submit</button>
