...
const Home = () => {
    return (
        ...
        <div class="container d-flex align-items-center flex-column">
            ...
            <h1 class="masthead-heading mb-0 text-dark" style="font-family: 'Kaushan Script', cursive;">IIITM GWALIOR
            </h1>
    ...
    <div class="jumbotron bg-dark text-white">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="masthead-heading mb-0 text-center" style="font-family: 'Kaushan Script', cursive;">
                        Upcoming Events:</h1>
                </div>
                <div class="col">
                    <div class="row h4">
                ...
                <section class="page-section portfolio" id="cultural">
                    <div class="container">
                        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0"
                            style="font-family: 'Kaushan Script', cursive;">Cultural Clubs</h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <a link={club}>
                            <div class="portfolio-item mx-auto">
                                <img class="img-fluid" style="width:25em" src={imagesource} alt="not found" />
                ...
                <section class="page-section portfolio" id="technical">
                    <div class="container">
                        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0"
                            style="font-family: 'Kaushan Script', cursive;">Technical Clubs</h2>
                    ...
                    <div class="container">
                        <div class="text-center">
                            <h2 class="page-section-heading d-inline-block text-white"
                                style="font-family: 'Kaushan Script', cursive;">ABOUT</h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 ml-auto">
                                <div class="wrap lead" style="font-family: 'Ubuntu', sans-serif;">This is a website which will
                            ...
                            <div class="col-lg-4 mr-auto mt-5 mt-lg-0">
                                <p class="wrap lead" style="font-family: 'Ubuntu', sans-serif;">This website will also help
                    ...
                    <div class="container">
                        <div class="text-center">
                            <h2 class="page-section-heading d-inline-block text-secondary mb-0"
                                style="font-family: 'Kaushan Script', cursive;">CONTACT</h2>
                        </div>
                        <div class="divider-custom">
                            <div class="divider-custom-line"></div>
                            <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
